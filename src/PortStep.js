...
const tutorialSteps = [
  {
    label: 'Exbae - Node, Inquirer, MySQL',
    imgPath: '/static/images/steppers/1-happy.jpg',
    src: 'https://github.com/csging/exbae',
  },
  {
...
class PortStep extends React.Component {
  state = {
    activeStep: 0,
  };
...
export default withStyles(styles, { withTheme: true })(PortStep);