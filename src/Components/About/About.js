          ...
          <div className="container">
            <div className="row"> 
              ...
              <div className="col m4 offset-s2 center-align">
                  ...
                  <div className="col m6 offset-s1">
                    <br></br><br></br><br></br><br></br>
                    <span className="about-text">
                        Hi, my name is Christian Gingrich. I'm 25, and almost 2 years ago I moved to San Diego from Dallas to get a fresh start!
                        I'm currently learning web dev and I work on projects every day so I can become the very best, like no one ever was. </span>
                  </div>
                </div> 
        </div>
        </div>
